# akm/core/config/genesis_config.py
import os
...
class GenesisConfig:
    ...
    def __init__(self):
        ...
        # Para la simulación, usamos un tiempo fijo o actual si es necesario.
        self._timestamp: int = int(os.getenv("AKM_GENESIS_TIMESTAMP", 1231006505))
        
        # Hash del bloque previo (Nulo).
        self._previous_hash: str = "0" * 64
        
        # Nonce "mágico". 
        # Nota: En modo simulación (Regtest), GenesisFactory recalculará esto si no cumple la dificultad,
        # así que este valor es solo un punto de partida histórico.
        ...
        # IMPORTANTE: Debe ser válida en Base58.
    ...
    @property
    def empty_hash_placeholder(self) -> str: return self._empty_hash_placeholder
    
    @property
    def coinbase_input_prev_tx(self) -> str: return self._coinbase_input_prev_tx
    @property
    def coinbase_input_index(self) -> int: return self._coinbase_input_index
    @property
    def coinbase_message(self) -> str: return self._coinbase_message
    
    @property
    def miner_address(self) -> str: return self._miner_address
    @property
    def tx_fee(self) -> int: return self._tx_fee